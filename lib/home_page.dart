...
class _HomePageState extends State<HomePage> {
  final speectToText = SpeechToText();
  ...
  Future<void> initSpeechToText() async {
    await speectToText.initialize();
    setState(() {});
  }

  Future<void> startListening() async {
    await speectToText.listen(onResult: onSpeechResult);
    setState(() {});
  }

  Future<void> stopListening() async {
    await speectToText.stop();
    setState(() {});
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: ZoomIn(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () async {
            if (await speectToText.hasPermission &&
                speectToText.isNotListening) {
              await startListening();
            } else if (speectToText.isListening) {
          ...
          child: Icon(speectToText.isListening ? Icons.stop : Icons.mic),
        ),
      ),
    );
  }
